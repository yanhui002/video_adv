...
class DataSet():
    ...
    def __init__(self, seq_length=40, class_limit=None, train_list='./video_data/data_file.csv', 
        ...
        # Get the data.
        self.data = self.get_data(train_list)
        self.test_data = self.get_data(test_list)
...
#        label_hot = label_hot[0]  # just get a single row
    ...
    def get_frames_for_sample(sample):
        ...
        filenames."""
        path = './video_data/' + sample[0] + '/' + sample[1] + '/'
        filename = sample[2]
        #print(path, filename)
        images = sorted(glob.glob(path + filename + '*.jpg.png'))
        return images
